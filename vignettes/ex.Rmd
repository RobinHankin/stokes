...
objects `ex`, `ey`, and `ez` (related package functionality is
discussed in [dx](dx.html)).  The dual basis to
$(\mathrm{d}x,\mathrm{d}y,\mathrm{d}z)$ is, depending on context,
written $(e_x,e_y,e_z)$, or $(i,j,k)$ or sometimes
