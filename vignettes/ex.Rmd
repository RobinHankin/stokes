...
discussed here.  Elementary forms `dx`, `dy` and `dz` are discussed in
`dx.Rmd`, and conjugate basis vectors `i`, `j` and `k` are discussed
in `ijk.Rmd`.  The dual basis to $(dx,dy,dz)$ is, depending on
context, written $(e_x,e_y,e_z)$, or $(i,j,k)$ or sometimes
