...
subtracted, and multiplied by a scalar, as for any other vectors.
Thus:
...
some implementations will appear in a different order: the stokes
...
$d\phi_{1:9}\colon\left(\mathbb{R}^9\right)^9\longrightarrow\mathbb{R}$).  Numerically:
