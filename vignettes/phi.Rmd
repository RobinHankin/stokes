...
@hankin2022_stokes; this function monograph discusses `phi()`.
Function `phi()` returns a tensor dual to the standard basis of
$V=\mathbb{R}^n$.  Here I discuss `phi()` but there is some overlap
between this vignette and the [tensorprod](tensorprod.html) vignette.

In a memorable passage, @spivak1965 states (theorem 4.1):

<div class="warning" style='padding:0.1em; background-color:#E9D8FD; color:#69337A; font-weight: normal;'>
<span>
...
is a basis for $\mathcal{J}^k(V)$, which therefore has dimension $n^k$.

</p>
<p style='margin-bottom:1em; margin-right:1em; text-align:right; font-family:Georgia'> <b>- Michael Spivak, 1965</b> <i>(Calculus on Manifolds, Perseus books).  Page 75</i>
</p></span>
</div>
...
Above we see package form for the result which is
$10\phi_1\otimes\phi_3 + 14\phi_1\otimes\phi_4 +
15\phi_2\otimes\phi_3 + 21\phi_2\otimes\phi_4$ in algebraic notation.
...
[Alt](Alt.html) vignette in the package.  It works nicely with `phi()`:
