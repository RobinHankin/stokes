...
standard basis of $V=\mathbb{R}^n$.  In a memorable passage,
@spivak1965 states (theorem 4.1):
...
As numerical verification, we will check that $\phi_3(e_4)=0$,
$\phi_3(e_5)=1$, $\phi_3(e_6)=0$:
