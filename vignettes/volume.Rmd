...
@hankin2022_stokes; this function monograph discusses `volume()`.
...
orthonormal basis such that $\left[v_1,\ldots,v_n\right]=\mu$.  This
...
<p style='margin-bottom:1em; margin-right:1em; text-align:right; font-family:Georgia'> <b>- Michael Spivak, 1965</b> <i>(Calculus on Manifolds, Perseus books).  Page 83</i>
</p></span>
</div>
...
that $\omega{\left(v_1,\ldots,v_n\right)}=\operatorname{det}(A)$, where
