...
The conjugate basis vectors `i`, `j` and `k` are discussed in
`ijk.Rmd`, and basis vectors $e_1$, $e_2$, $e_2$ are discussed in
`ex.Rmd`.  @spivak1965, in a memorable passage, states (p89):
