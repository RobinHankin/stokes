...
$\phi_i\left(v_j\right)=\delta_{ij}$.  The space spanned by suchq
products has a natural representation in R as an array of dimensions
$n\times\cdots\times n$.  However, it is more efficient and
conceptually cleaner to consider a sparse array.  Considering the case
$n=5,k=4$ 
...
k <- 4
n <- 5
S <- as.ktensor(matrix(c(5,4,1,2,2,5,2,3,1,3,4,3),3,4),0.5 + 1:3)
S
```

So $S$ is a 4-tensor, mapping $V^4$ to $\mathbb{R}$, where
$V=\mathbb{R}^5$.  Here we have
$S=3.5\phi_1\otimes\phi_5\otimes\phi_1\otimes\phi_3+1.5\phi_5\otimes\phi_2\otimes\phi_2\otimes\phi_3+2.5\phi_4\otimes\phi_2\otimes\phi_3\otimes\phi_4$.

We will define $E$ to be a random point in $V^k$:
