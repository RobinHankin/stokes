...
35}{5!}=35$.  To represent $x\wedge y$ as an alternating form (that
is, an object of class `kform`), we need a `kform` object with
_single_ index entry `1 2 3 4 7`.  This would need coefficient 35, and
