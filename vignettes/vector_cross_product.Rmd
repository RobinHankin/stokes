...
@hankin2022_stokes; this function monograph discusses
`vector_cross_product()`.  The *vector cross product* of two vectors
...
<b>- Michael Spivak, 1965</b> <i>(Calculus on Manifolds, Perseus books). Pages 83-84</i>
...
$\mathbf{v}_1,\ldots,\mathbf{v}_{n-1},\mathbf{v}_1\times\cdots\times\mathbf{v}_n$
...
\[
\mathbf{v}_{\sigma(1)}\times\cdots\times\mathbf{v}_{\sigma(n-1)} =
\operatorname{sgn}\sigma\cdot
\mathbf{v}_{1}\times\cdots\times\mathbf{v}_{n-1}
\]
