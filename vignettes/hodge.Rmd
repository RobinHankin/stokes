...
Given a $k$-form $\beta$, function `hodge()` returns its Hodge dual
$\star\beta$.  Formally, if $V={\mathbb R}^n$, and $\Lambda^k(V)$ is
the space of alternating linear maps from $V^k$ to ${\mathbb R}$, then
