...
alternating map by definition.  We can see this cancellation
numerically by considering $T$, a linear map corresponding to the
second row of `S` above, that is, `[2 2 3]`.  We have
